...
if ($sortMode !== '' && $sortMode !== 'none') {
	switch ($sortMode) {
		case 'sortInvoiceDate_asc':
			$billingPeriodSortOrder = 'asc';
			break;
		case 'sortInvoiceDate_desc':
			$billingPeriodSortOrder = 'desc';
			break;
		default:
			$billingPeriodSortOrder = $prevBillingPeriodSortOrder;
...
$sortInvoiceDateAscActive = (strtolower($billingPeriodSortOrder) === 'asc') ? 'is-active' : '';
$sortInvoiceDateDescActive = (strtolower($billingPeriodSortOrder) === 'asc') ? '' : 'is-active';
...
$sortModeValue = (strtolower($billingPeriodSortOrderSaved) === 'asc') ? 'sortInvoiceDate_asc' : 'sortInvoiceDate_desc';
