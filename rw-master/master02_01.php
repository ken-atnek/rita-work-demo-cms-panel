...
#検索項目フォームのアクティブ判定
$activeSearchForm = '';
if ($searchConditions['companyName'] !== '' || $searchConditions['startDay'] !== '' || $searchConditions['endDay'] !== '') {
...
print <<<HTML
    <main class="inner-02-01">
      <section class="container-company-list">
        <h2>法人一覧</h2>
          ...
          <article id="innerSearch" class="{$activeSearchForm}">
            <div class="blockGrid">
              <ul class="box-search-items">
                <li class="item-name">
                  <h4>法人名</h4>
                  <input type="text" name="searchCompanyName" value="{$searchConditions['companyName']}">
                </li>
...
print <<<HTML
        ...
        <div class="bottom-box-btn">
          <button type="button" class="item-register" onclick="checkNewCorporation()"><span>新規法人登録</span></button>
        </div>
      </section>
...
print <<<HTML
    ...
    <script src="./assets/js/master02_01.js" defer></script>
  </body>
</html>
