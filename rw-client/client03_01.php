...
try {
  ...
  if (function_exists('makeLog')) {
    makeLog('[client03_01] master JSON load failed: ' . $e->getMessage());
  }
  $jsonMasters = [];
}
#募集職種マスタ
    ...
    print <<<HTML
            <li {$isActiveClass}>
              ...
              <div class="box-details">
                <a href="./client03_01_01.php?facId={$jobCard['facility_id']}&jobId={$jobCard['job_id']}"></a>
...
print <<<HTML
        ...
        <div class="bottom-box-btn">
          <button type="button" class="item-back" onclick="location.href='./client01_01.php?facId={$facId}'">戻る</button>
        </div>
      </section>
      ...
      <div class="inner-modal">
        ...
        <div class="box-details">
          ...
          <div class="box-btn">
            ...
            <button type="button" class="btn-confirm" onclick="location.href='./client03_01_01.php?&facId={$facId}'">はい</button>
          </div>
        </div>
      </div>
    </article>
